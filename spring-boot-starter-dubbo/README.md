...
* 在application.properties添加dubbo的相关配置信息,样例配置如下(已调整为dubbo.properties的属性配置方式):

```properties
spring.dubbo.application.name=spring-boot-starter-dubbo-provider-test
spring.dubbo.registry.address=multicast://224.0.0.0:1111
