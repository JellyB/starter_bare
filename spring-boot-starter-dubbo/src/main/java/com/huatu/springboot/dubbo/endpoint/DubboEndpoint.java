...
import com.huatu.springboot.dubbo.domain.ClassIdBean;
import com.huatu.springboot.dubbo.listener.ConsumerSubscribeListener;
import com.huatu.springboot.dubbo.listener.ProviderExportListener;
import com.huatu.springboot.dubbo.listener.StaticsFilterHelper;
...
public class DubboEndpoint extends AbstractEndpoint<Map<String, Object>> {
    ...
    public Map<String, Object> getRuntime() {
        ...
        runtimeMap.put("properties", this.dubboProperties);
